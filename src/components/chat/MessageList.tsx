                        ...
                        switch (part.type) {
                          ...
                          case "tool-invocation":
                            ...
                            const toolLabels: Record<string, { pending: string; done: string }> = {
                              str_replace_editor: { pending: "Writing component...", done: "Component written" },
                              ...
                              <div key={partIndex} className="inline-flex items-center gap-2 mt-2 px-3 py-1.5 bg-neutral-50 rounded-lg text-xs border border-neutral-200">
                                {tool.state === "result" && tool.result ? (
                                  <>
                                    ...
                                    <span className="text-neutral-600">{label.done}</span>
                                  </>
                                ) : (
                                  <>
                                    <Loader2 className="w-3 h-3 animate-spin text-blue-600" />
                                    <span className="text-neutral-600">{label.pending}</span>
                                  </>
                                )}
                              </div>
                            );
